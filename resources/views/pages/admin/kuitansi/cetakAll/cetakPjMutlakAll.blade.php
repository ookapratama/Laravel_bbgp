...
<body>
    ...
    @foreach ($datas as $i => $data)
        ...
        <div class="" style="margin-top: -40px">
            <img style="position: absolute; left: 20px; top: 20px; width: 110px;" src="{{ asset('img_template/iconbbgp.png') }}" alt="Logo Kiri">
                <div class="header">
                    ...
                    <tr style="padding: 10px">
                        ...
                        <td>
                            <p><span class="highlight">:
                                    {{ $data->peserta->pegawai->nip ?? $data->peserta->nip }}</span>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <p style="text-align: justify">:
                                {{ $data->peserta->pegawai->jabatan ?? $data->peserta->nip }}
