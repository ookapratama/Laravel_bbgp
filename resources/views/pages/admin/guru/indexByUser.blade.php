                                        ...
                                        <tbody>
                                            {{-- @foreach ($datas as $i => $data) --}}
                                                <tr>
                                                    ...
                                                    <td>{{ $datas->kategori_jabatan ? $datas->kategori_jabatan : 'Tidak ada' }}</td>
                                                    <td>{{ $datas->tugas_jabatan ? $datas->tugas_jabatan : 'Tidak ada' }}</td>
                                                    ...
                                                    <td>
                                                        {{-- <a href="#"
                                                            onclick="verifikasi({{ $datas->id }}, 'eksternal', '{{ $datas->is_verif }}')"
